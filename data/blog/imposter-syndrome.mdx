...
<div  style={{"paddingLeft":"1.75rem"}}>
IQ measurements is a very controversial measure of intelligence, but it tends to shows that average IQ among software developpement is much higher than the average, which might excruciate Imposter syndrome. Indeed, It's way easier to feel like a fraud among bright and sucessfull peoples.

</div>

* **Remote work**
<div  style={{"paddingLeft":"1.75rem"}}>
Imposter syndrome seems to be way more prevalent in remote worker [^3]. Tech is one of the few sectors that allows for widespread remote work.
</div>
...
Point is, projects can go wrong for many reasons. Try to identify them and your level of responsability in them.
</div>
...
[^3]:  Boutchard J. [Has Remote Work Created an Imposter Syndrome Problem?](https://www.cascade.app/blog/remote-work-imposter-syndrome). Cascade blog.  &nbsp;
